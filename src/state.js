...
export async function removeModel (id, toTrash = true) {
  await invoke('remove_model', { id, toTrash });
}
export async function createTileFromModel (id) {
  await invoke('create_tile_from_model', { id });
}
